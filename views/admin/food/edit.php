<div class="card p-4">
    ...
    <form action="?action=food_editPost&id=<?= (int) $old['id'] ?>" method="post" enctype="multipart/form-data" class="row g-3" style="max-width: 700px;">
        ...
        <div class="col-12">
            ...
            <?php if (!empty($old['image'])): ?>
                <img src="<?= h(BASE_ASSETS_UPLOADS . $old['image']) ?>" alt="" width="90" height="90" style="object-fit: cover; border-radius: 8px;">
            <?php else: ?>
        ...
        <div class="col-12">
            <label class="form-label">Đổi hình ảnh (bỏ trống nếu giữ nguyên)</label>
