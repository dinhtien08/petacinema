...
<head>
    ...
    <title>Thêm phòng - PETACINEMA Admin</title>
...
<main class="content">
    <div class="mb-4">
        <h4 class="mb-1 fw-bold">Thêm phòng chiếu</h4>
        <p class="text-muted mb-0">Tạo mới một phòng chiếu.</p>
    </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <form method="POST" action="?action=roomAddProcess">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select name="room_type_id" class="form-select" required>
                        ...
                        <?php foreach ($listRoomType as $roomType): ?>
                            <option value="<?= $roomType['id'] ?>"><?= htmlspecialchars($roomType['name']) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="mb-4">
                ...
                <button type="submit" class="btn btn-danger">Lưu phòng</button>
            </form>
        </div>
    </div>
</main>
