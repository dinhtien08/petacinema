...
<div class="card shadow-sm mb-3">
    <div class="card-body">
        ...
        <form action="<?= BASE_URL ?>?action=staff_payment_list" method="GET" class="row g-2 align-items-end">

            <input type="hidden" name="action" value="staff_payment_list">
            ...
            <div class="col-md-2 d-flex gap-2">
                ...
                <a href="<?= BASE_URL ?>?action=staff_payment_list" class="btn btn-outline-secondary" title="Bỏ lọc">
                        ...
                        <?php foreach ($payments as $payment) : ?>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-4">
                                    <a
                                        href="<?= BASE_URL ?>?action=staff_payment_detail&id=<?= $payment['id'] ?>"
